...
const apps: VibecodedApp[] = [
  {
    id: '1',
    name: 'Nexora',
    description: 'AI-powered growth systems helping ambitious brands scale with automated acquisition, sales systems, and performance-driven execution.',
    tags: ['AI Growth', 'Automation', 'Performance'],
